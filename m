...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C80076181F2
	for <lists+etnaviv@lfdr.de>; Thu,  3 Nov 2022 16:16:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCDDD10E660;
...
Subject: [PATCH v3 12/23] drm/fb_helper: Rename field fbdev to info in struct
 drm_fb_helper
