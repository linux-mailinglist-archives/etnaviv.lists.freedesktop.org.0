...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 818962785E0
	for <lists+etnaviv@lfdr.de>; Fri, 25 Sep 2020 13:32:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C6E8A6EC93;
...
Content-Type: multipart/mixed; boundary="===============1123017981=="
