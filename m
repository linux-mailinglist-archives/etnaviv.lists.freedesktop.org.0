...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A92C293B30
	for <lists+etnaviv@lfdr.de>; Tue, 20 Oct 2020 14:20:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 709456EC6C;
...
Subject: [PATCH v5 02/10] drm/cma-helper: Remove empty
