...
Received: from mail.lfdr.de
	...
	id RpheC8/bUGqe6QIAu9opvQ
	(envelope-from <etnaviv-bounces@lists.freedesktop.org>)
	for <lists+etnaviv@lfdr.de>; Fri, 10 Jul 2026 13:47:27 +0200
X-Original-To: lists+etnaviv@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D36C73A63E
	for <lists+etnaviv@lfdr.de>; Fri, 10 Jul 2026 13:47:26 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=none;
	dmarc=none;
	spf=pass (mail.lfdr.de: domain of etnaviv-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=etnaviv-bounces@lists.freedesktop.org
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E4CF10F84B;
	Fri, 10 Jul 2026 11:47:25 +0000 (UTC)
X-Original-To: etnaviv@lists.freedesktop.org
Delivered-To: etnaviv@lists.freedesktop.org
Received: from metis.whiteo.stw.pengutronix.de
 (metis.whiteo.stw.pengutronix.de [185.203.201.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 08C6D10F84B
 for <etnaviv@lists.freedesktop.org>; Fri, 10 Jul 2026 11:47:23 +0000 (UTC)
Received: from ptz.office.stw.pengutronix.de ([2a0a:edc0:0:900:1d::77]
 helo=[IPv6:::1])
 by metis.whiteo.stw.pengutronix.de with esmtp (Exim 4.92)
 (envelope-from <l.stach@pengutronix.de>)
 id 1wi9hL-0003b8-Pa; Fri, 10 Jul 2026 13:47:15 +0200
Message-ID: <fded212b216f1f4d3afa7465ae64aa9b96b80288.camel@pengutronix.de>
...
Cc: etnaviv@lists.freedesktop.org, dri-devel@lists.freedesktop.org, 
 ...
 <cgmeiner@igalia.com>
Date: Fri, 10 Jul 2026 13:47:13 +0200
...
X-Rspamd-Queue-Id: 7D36C73A63E

Am Freitag, dem 10.07.2026 um 11:00 +0200 schrieb Christian Gmeiner:
...
> @@ -296,6 +296,30 @@ static int etnaviv_ioctl_get_param(struct drm_device=
 *dev, void *data,
...
file)
> @@ -530,7 +555,7 @@ static const struct drm_driver etnaviv_drm_driver =3D=
 {
>  	.name               =3D "etnaviv",
>  	.desc               =3D "etnaviv DRM",
>  	.major              =3D 1,
