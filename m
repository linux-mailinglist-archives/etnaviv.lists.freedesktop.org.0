...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D05360A0FD
	for <lists+etnaviv@lfdr.de>; Mon, 24 Oct 2022 13:21:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EDC5410E40E;
...
Subject: [PATCH v2 06/21] drm/ingenic: Don't set struct
