...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 98496BC24AB
	for <lists+etnaviv@lfdr.de>; Tue, 07 Oct 2025 19:45:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7144D10E1AD;
	Tue,  7 Oct 2025 17:45:18 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=ti.com header.i=@ti.com header.b="jt9lsWW6";
	dkim-atps=neutral
X-Original-To: etnaviv@lists.freedesktop.org
Delivered-To: etnaviv@lists.freedesktop.org
Received: from lelvem-ot01.ext.ti.com (lelvem-ot01.ext.ti.com [198.47.23.234])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 77F9010E1AD
 for <etnaviv@lists.freedesktop.org>; Tue,  7 Oct 2025 17:45:16 +0000 (UTC)
Received: from fllvem-sh04.itg.ti.com ([10.64.41.54])
 by lelvem-ot01.ext.ti.com (8.15.2/8.15.2) with ESMTP id 597HjBuI3872325;
 Tue, 7 Oct 2025 12:45:11 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
 s=ti-com-17Q1; t=1759859111;
 bh=pLv/nXhm9xCaG1dysrcQbUAV/Fi1VS6icpLjDRe0/+I=;
 h=Date:CC:Subject:From:To:References:In-Reply-To;
 b=jt9lsWW6POXdgKtBSZVDwe6cdl4Be60nTFHkN8iYu1jpuoXMsUJWdTSIpzP2dkZA2
 vAFdAa1Fuzah8xIGbDvDiJxNxsEbdwUGCY+E+N/LlMEYnHGxXi7x5rgBuJyLTFcSVO
 U9ENm6pSbo/4UM8PLoEXu4pzXInCGre1LX6tU8xo=
Received: from DFLE114.ent.ti.com (dfle114.ent.ti.com [10.64.6.35])
 by fllvem-sh04.itg.ti.com (8.18.1/8.18.1) with ESMTPS id 597HjBOS860438
 (version=TLSv1.2 cipher=ECDHE-RSA-AES128-SHA256 bits=128 verify=FAIL);
 Tue, 7 Oct 2025 12:45:11 -0500
Received: from DFLE210.ent.ti.com (10.64.6.68) by DFLE114.ent.ti.com
 (10.64.6.35) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.55; Tue, 7
 Oct 2025 12:45:11 -0500
Received: from lelvem-mr06.itg.ti.com (10.180.75.8) by DFLE210.ent.ti.com
 (10.64.6.68) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.2.2562.20 via Frontend
 Transport; Tue, 7 Oct 2025 12:45:11 -0500
Received: from localhost (rs-desk.dhcp.ti.com [128.247.81.144])
 by lelvem-mr06.itg.ti.com (8.18.1/8.18.1) with ESMTP id 597HjBEZ1262992;
 Tue, 7 Oct 2025 12:45:11 -0500
MIME-Version: 1.0
Content-Transfer-Encoding: quoted-printable
Content-Type: text/plain; charset="UTF-8"
Date: Tue, 7 Oct 2025 12:45:11 -0500
Message-ID: <DDC9ZMQIW0Z2.2GWLFRIUERSF7@ti.com>
CC: <etnaviv@lists.freedesktop.org>, <detheridge@ti.com>
Subject: Re: [PATCH] drm/etnaviv: force flush on power register ops
From: Randolph Sapp <rs@ti.com>
To: Randolph Sapp <rs@ti.com>, "Kumar, Udit" <u-kumar1@ti.com>,
...
On Tue Oct 7, 2025 at 10:45 AM CDT, Randolph Sapp wrote:
> On Mon Oct 6, 2025 at 9:05 PM CDT, Udit Kumar wrote:
>>
>> On 10/7/2025 2:00 AM, rs@ti.com wrote:
>>> From: Randolph Sapp <rs@ti.com>
>>>
>>> Force a cache flush on power register operations during etnaviv_hw_rese=
t
...
>>
>>> occasional failures with etnaviv_hw_reset during boot and after multipl=
e
...
>>> @@ -544,12 +544,14 @@ static int etnaviv_hw_reset(struct etnaviv_gpu *g=
pu)
>>>  =20
...
Follow up on this, there are other power operations in this driver that are
susceptible.

Seems there are only two calls to gpu_read_power that can be saved by keepi=
ng
these instructions separate.

I'll still wait on a maintainer to comment, but always performing an immedi=
ate
readback seems like a good idea right now.
